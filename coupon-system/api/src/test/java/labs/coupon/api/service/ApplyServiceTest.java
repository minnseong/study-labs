...
import labs.coupon.api.coupon.domain.CouponBoxRepository;
import labs.coupon.api.user.domain.User;
import labs.coupon.api.user.domain.repository.UserRepository;
import labs.coupon.api.coupon.domain.CouponRepository;
import labs.coupon.api.coupon.service.CouponService;
